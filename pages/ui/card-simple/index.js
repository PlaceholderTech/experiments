        ...
        <div className="mx-auto lg:w-3/5 lg:flex lg:flex-row lg:h-auto">
          ...
          <div className="bg-white p-8 rounded-bl-md rounded-br-md lg:rouned-bl-none lg:rounded-tr-md">
            <h2 className="text-gray-700 font-semibold">
              This is a card component build out of tailwindcss. Excellent for
              listing products and about sections.
            </h2>
            <p className="text-sm text-gray-600 mt-4">
              Tailwindcss is a utility based framework, unlike Bootstrap and
              Material where they use components for pretty much everything.
              Tailwindcss is a low level framework to build custom components
            ...
            <div className="flex items-center mt-8">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-400 text-sm">28th March 2021</p>
                </div>
              </div>
